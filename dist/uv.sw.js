(() => {
        ...
        try {
          ...
          if (
            ...
            if (!/\s*?((inline|attachment);\s*?)filename=/i.test(e)) {
              ...
              f.headers["content-disposition"] = `${t}; filename=${JSON.stringify(
                r
              )}`;
            }
          }
              ...
              case "worker":
                {
                  const e = [
                    ...
                    .join(",");
                  (f.body = `if (!self.__uv2 && self.importScripts) { ${c.createJsInject(
                    this.address,
                ...
                return new Response(
                  (function (e, t, r, i, s, o, n) {
                    if ("The specified host could not be resolved." === i)
                      return (function (e, t) {
                        const r = new URL(e),
                          i = `remoteHostname.textContent = ${JSON.stringify(
                            r.hostname
                          )};bareServer.href = ${JSON.stringify(
                            t
                          )};uv2Hostname.textContent = ${JSON.stringify(
                            location.hostname
                          )};reload.addEventListener("click", () => location.reload());uv2Version.textContent = ${JSON.stringify(
                            "2.0.0"
                          )};`;
                        return `<!DOCTYPE html><html><head><meta charset='utf-8' /><title>Error</title></head><body><h1>This site can’t be reached</h1><hr /><p><b id="remoteHostname"></b>’s server IP address could not be found.</p><p>Try:</p><ul><li>Verifying you entered the correct address</li><li>Clearing the site data</li><li>Contacting <b id="uv2Hostname"></b>'s administrator</li><li>Verifying the <a id='bareServer' title='Bare server'>Bare server</a> isn't censored</li></ul><button id="reload">Reload</button><hr /><p><i>Ultraviolet2 v<span id="uv2Version"></span></i></p><script src="${
                          "data:application/javascript," + encodeURIComponent(i)
                        }"><\/script></body></html>`;
                      })(o, n);
                    const a =
                      ...
                      `for (const node of document.querySelectorAll("#uv2Hostname")) node.textContent = ${JSON.stringify(
                        location.hostname
                      )};reload.addEventListener("click", () => location.reload());` +
                      `uv2Version.textContent = ${JSON.stringify("2.0.1")};`;
                    return (
                      ...
                      '</tbody></table><textarea id="errorTrace" cols="40" rows="10" readonly></textarea><p>Try:</p><ul><li>Checking your internet connection</li><li>Verifying you entered the correct address</li><li>Clearing the site data</li><li>Contacting <b id="uv2Hostname"></b>\'s administrator</li><li>Verify the <a id=\'bareServer\' title=\'Bare server\'>Bare server</a> isn\'t censored</li></ul><p>If you\'re the administrator of <b id="uvHostname"></b>, try:</p><ul><li>Restarting your Bare server</li><li>Updating Ultraviolet2</li><li>Troubleshooting the error on the <a href="https://github.com/titaniumnetwork-dev/Ultraviolet2" target="_blank">GitHub repository</a></li></ul><button id="reload">Reload</button><hr /><p><i>Ultraviolet2 v<span id="uv2Version"></span></i></p>' +
                      `<script src="${
                        "data:application/javascript," + encodeURIComponent(a)
                      }"><\/script></body></html>`
                    );
    ...
    class s {
      constructor(e, t) {
        (this.request = e),
          (this.raw = t),
          (this.Ultraviolet2 = e.Ultraviolet2),
          (this.headers = {});
    ...
    class o {
      ...
      get url() {
        return this.Ultraviolet2.meta.url;
      }
      set url(e) {
        this.Ultraviolet2.meta.url = e;
      }
      get base() {
        return this.Ultraviolet2.meta.base;
      }
      set base(e) {
        this.ultraviolet2.meta.base = e;
      }
    }
    class n {
      #e;
